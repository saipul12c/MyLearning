            ...
            <div className="flex items-center gap-1 p-1 bg-white/5 rounded-xl border border-white/5 h-fit">
              {['all', 'active', 'draft'].map((btn) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-widest transition-all ${statusFilter === btn
                ...
                <tbody className="divide-y divide-white/5">
                  {filteredCourses.map((course: any) => (
                    <tr key={course.id} className="hover:bg-purple-500/[0.03] transition-all group">
                      ...
                      <td className="p-4">
                        <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-[8px] font-black uppercase tracking-widest ${course.isPublished
            ...
            {(() => {
              ...
              const renderPageButton = (p: number) => (
                <button
                  ...
                  disabled={refLoading}
                  className={`w-10 h-10 rounded-xl flex items-center justify-center text-[11px] font-black transition-all border ${refPage === p
