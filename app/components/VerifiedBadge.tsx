...
export default function VerifiedBadge({ 
  ...
  return (
    <span 
      className={`inline-flex items-center justify-center text-blue-400 relative group/vbadge animate-in fade-in zoom-in duration-500 delay-100 ${className}`}
    >
      <BadgeCheck 
        size={size} 
        fill="currentColor" 
      ...
      {showTooltip && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-max max-w-[200px] invisible opacity-0 group-hover/vbadge:opacity-100 group-hover/vbadge:visible translate-y-2 group-hover/vbadge:translate-y-0 transition-all duration-300 pointer-events-none z-[100]">
